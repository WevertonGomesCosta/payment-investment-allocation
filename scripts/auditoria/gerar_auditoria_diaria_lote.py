...
def main() -> None:
    ...
    parser.add_argument('--xlsx', default=str(RAIZ / 'saidas' / 'operacional' / 'auditoria_diaria_lote_6630_64_fev_v54.xlsx'))
    parser.add_argument('--csv', default=str(RAIZ / 'saidas' / 'operacional' / 'auditoria_diaria_lote_6630_64_fev_v54.csv'))
