...
START_OFFSET = int(os.getenv('V133_START_OFFSET', '0') or 0)
MAX_DIAS = int(os.getenv('V133_MAX_DIAS', '0') or 0)
CHUNK_JSON = BASE_OPERACIONAL / f'grade_diaria_hibrida_v133_offset_{START_OFFSET:03d}.json'
