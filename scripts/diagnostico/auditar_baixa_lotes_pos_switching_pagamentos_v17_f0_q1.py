...
BASELINE_ENTRADA="1b56103"; BASELINE_CODIGO_ANTERIOR="dd70768"; BASELINE_DADOS_ANTERIOR="1b56103"
...
def main():
    ...
    print('=== AUDITORIA V17-F0-Q.1.5-C — RESTAURA GATE CANONICO E RECONCILIA PASSADOS POS ===')
