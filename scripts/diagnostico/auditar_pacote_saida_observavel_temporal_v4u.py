...
def main() -> int:
    ...
    ativos = construir_linhas_lotes_consolidados(ctx, saida, tipo='ativos', pacote_saida_observavel_temporal=p)
    exauridos = construir_linhas_lotes_consolidados(ctx, saida, tipo='exauridos', pacote_saida_observavel_temporal=p)
    am = construir_amostras_pagamentos_operacionais(saida, limite=1000, contexto=ctx, pacote_saida_observavel_temporal=p)
    ...
    out = {
      ...
      "qtd_aplicacoes_por_lote_preenchidas": a.get("qtd_aplicacoes_por_lote_preenchidas", 0),
      "qtd_valores_originais_por_lote_positivos": a.get("qtd_valores_originais_por_lote_positivos", 0),
      "aplicacoes_por_lote_sem_vazios": a.get("aplicacoes_por_lote_sem_vazios", False),
      "valores_originais_por_lote_validos": a.get("valores_originais_por_lote_validos", False),
