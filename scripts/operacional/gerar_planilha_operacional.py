    ...
    if quadro_central_full is not None and len(quadro_central_full):
        ...
        for _, row_c in quadro_central_full.iterrows():
            rows_central.append([
                ...
                row_c.get('classe_pagamento_operacional'), row_c.get('lote_sugerido_original'), row_c.get('lote_final_central'),
                ...
                row_c.get('penalidade_fragmentacao_central'), row_c.get('saldo_antes_central'), row_c.get('bruto_central'),
