...
JANELA_FIM = date(2026, 5, 20)
START_OFFSET = int(os.getenv('V130_START_OFFSET', '0') or 0)
MAX_DIAS = int(os.getenv('V130_MAX_DIAS', '0') or 0)
CHUNK_JSON = BASE_OPERACIONAL / f'grade_diaria_parametrizada_v130_offset_{START_OFFSET:03d}.json'
...
def _gerar_cenarios_parametrizados(acoes):
    ...
    # agrupados integrais válidos, sempre para o mesmo destino
