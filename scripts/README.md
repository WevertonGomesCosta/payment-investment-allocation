...
Estrutura canônica da baseline vigente V202:
...
Scripts que geram saída operacional devem consumir `nucleo.saida_canonica.construir_saida_canonica(...)`. Scripts históricos ou diagnósticos que recalculam saídas próprias não têm autoridade operacional.
