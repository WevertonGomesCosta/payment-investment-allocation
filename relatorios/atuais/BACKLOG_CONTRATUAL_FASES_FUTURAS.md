...
## 9. Continuação possível após a V90

20. Só considerar refino do `proxy v3` se a auditoria fina mantida na V90 mostrar padrão suficientemente concentrado, localizado e economicamente coerente.
...
22. Com a consolidação dos helpers duplicados de baixo risco na V90, a próxima limpeza arquitetural ampla só deve ocorrer se restarem grupos duplicados com ganho real de manutenção.
...
## 10. Prioridade imediata pós-V90
