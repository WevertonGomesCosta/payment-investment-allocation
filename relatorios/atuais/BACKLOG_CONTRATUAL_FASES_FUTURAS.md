...
## 9. Continuação possível após a V81

20. Só considerar refino do `proxy v3` se a auditoria fina da V81 mostrar padrão suficientemente concentrado, localizado e economicamente coerente.
