...
- `nucleo/caixa_recebidos_auditaveis.py` → contrato mínimo da F1 + materialização de `recebido_auditavel`
...
- abertura da Etapa 2 da F1 por materialização de `recebido_auditavel`;
- manutenção da baseline limpa da V60 como base funcional;
