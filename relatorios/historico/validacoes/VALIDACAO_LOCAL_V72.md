...
- abertura da Etapa 8 da F1 por materialização de `decisao_local_v1` com proxy econômico v3;
...
## Evidências observáveis da V72

- o diagnóstico de `decisao_local_v1` passa a exibir `pagamento_id`, `data_pagamento`, lote escolhido, fonte escolhida, critério de decisão, score do proxy econômico v3 e cobertura;
