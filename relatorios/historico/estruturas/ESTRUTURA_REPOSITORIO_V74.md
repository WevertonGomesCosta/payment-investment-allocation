...
- baseline atualizada para **V74**;
- sincronização documental entre `README`, contrato, backlog e relatórios vigentes;
- preservação da decisão local com `proxy econômico v3` como baseline monofonte vigente;
- preservação da auditoria comparativa `v2 vs v3` como camada diagnóstica reproduzível;
