...
## Ajuste incremental adicional da V78
...
A V78 não substitui a decisão local v1 vigente. Ela materializa um **benchmark shadow** que, para cada pagamento futuro/pendente, usa apenas lotes resgatáveis elegíveis e calcula uma alocação multifonte local com pesos legados de IOF, IR, idade, liquidez, cliff e VPL, apenas para comparação diagnóstica com a escolha monofonte vigente.
