# CONTRATO INDIVIDUAL DA ETAPA 2 — VALIDAÇÃO DO PACOTEENTRADARESOLVIDA
...
- switching: `lote_id_antes`, `lote_id_depois`, `data_aplicacao`, `valor_liquido_migrado`, `investimento`.
...
## 13. Fluxograma da Etapa 2 — Validação do PacoteEntradaResolvida
