...
A V138 integra o `alocador_pagamentos_terminal_v1` ao fluxo oficial de um recorte curto real de pagamentos. O recorte passa a comparar saldo disponível, lote não aportado, lote aportado, combinação mínima e cenário com switching elegível já filtrado pelo comparador híbrido, sob foco explícito em patrimônio líquido terminal.
