...
ITENS_INVENTARIO_LEGADO_PIPELINE: tuple[ItemInventarioLegadoPipeline, ...] = (
    ...
    _item(
        ...
        'Fallback standalone foi removido; chamada sem PacoteSaidaObservavelOficial preserva apenas falha contratual explícita.',
        False,
    ...
    _item(
        ...
        'Fallback antigo de Situação Atual foi removido; console renderiza exclusivamente blocos oficiais do PacoteSaidaObservavelOficial.',
        False,
    ...
    _item(
        ...
        'Fallback antigo de amostras de pagamentos foi removido; console usa somente listas oficiais do bloco_console.',
        False,
        'bloco_console.ultimos_pagamentos; bloco_console.pagamentos_data_referencia; bloco_console.proximos_pagamentos',
        'baixo_apos_remocao; medio_se_reintroduzido',
        'preservar_rota_oficial_sem_fallback',
        'ME-518A concluida; ME-520B3 reclassificacao',
    ...
    _item(
        ...
        'Fallback XLSX sem PacoteSaidaObservavelOficial foi removido; gerador valida pacote oficial preparado e abas oficiais completas.',
        False,
        'bloco_xlsx.abas e bloco_xlsx.situacao_atual_blocos',
        'baixo_apos_remocao; alto_se_reintroduzido',
        'preservar_rota_xlsx_oficial_sem_fallback',
