...
def consolidar_resultado_limpeza_depreciacao(
    ...
    bloqueados = [item for item in itens if item.classificacao == _CLASSIFICACAO_BLOQUEADO]
    legados = [item for item in itens if item.classificacao in {_CLASSIFICACAO_LEGADO, _CLASSIFICACAO_BLOQUEADO}]
    ...
    historicos = [item for item in itens if item.classificacao == _CLASSIFICACAO_HISTORICO]
